...
| [#42](https://github.com/ZhannaM85/synapse-map/issues/42) | feat: extract session recaps (away_summary) as a high-signal extraction source | Depends on #3, #8 — supplements word-frequency layers with LLM-written session summaries |
